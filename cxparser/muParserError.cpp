...
namespace mu
{
    ...
    :m_vErrMsg(0)
  {
	...
	m_vErrMsg[ecMISSING_BIGBRACKET]  = "Missing paren bracket";
	m_vErrMsg[ecCLASS_CONFICT]  = "Class define error";
	m_vErrMsg[ecCLASSOBJ_CONFICT]  = "Class define error";
	m_vErrMsg[ecCLASSFUC_CONFICT] = "Class function error";
	m_vErrMsg[ecCLASSMEMOPT_CONFICT]  =" Class member operation error";
	m_vErrMsg[ecCLASSPOINT_CONFICT]  =" Class pointer operation error";
    #if defined(_DEBUG)
